...
class DashboardWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        for n in names:
            ...
            if n == "Assignment 2":
                ...
                b.clicked.connect(self.open_fifth_assignment)
            elif n == "Assignment 6":
    ...
    def open_fifth_assignment(self):
        from GUI.FifthAssignment import FifthAssignment
        self.fifth_window = FifthAssignment()
